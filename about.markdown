...
<div class="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
    ...
    <div class="md:sticky md:top-24">
        <div class="bg-white dark:bg-card-dark rounded-xl overflow-hidden">
            ...
            <div class="p-6">
                <h2 class="font-display text-xl font-bold mb-4">Quick Facts</h2>
                <ul class="space-y-3">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <span class="text-slate-600 dark:text-slate-400">Professional Performer</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="material-symbols-outlined text-primary dark:text-secondary">psychology</span>
                        <span class="text-slate-600 dark:text-slate-400">Certified Music Educator</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="material-symbols-outlined text-primary dark:text-secondary">group</span>
...
<section class="mt-16 bg-primary dark:bg-primary text-white rounded-xl p-8 md:p-12">
    <div class="text-center">
        <h2 class="font-display text-3xl font-bold dark:text-secondary mb-4">Let's Make Music Together</h2>
        <p class="text-slate-200 max-w-2xl mx-auto mb-8">
            Whether you're interested in private lessons, looking to book a performance, or want to collaborate on a musical
            project, I'd love to hear from you.
        </p>
        <a href="/contact" class="inline-flex items-center justify-center px-8 py-3 rounded-full bg-secondary text-primary font-bold hover:scale-105 transition-transform">
            Get in Touch
        </a>
    </div>
</section>

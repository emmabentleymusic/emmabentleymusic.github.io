...
<section class="mb-16">
    <h2 class="font-display text-3xl font-bold text-primary dark:text-secondary mb-8 text-center">Testimonials</h2>
...
<section class="text-center bg-primary dark:bg-primary text-white rounded-xl p-8 md:p-12">
    <h3 class="font-display text-2xl font-bold dark:text-secondary mb-4">Ready to Learn More?</h3>

...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
    ...
    <div class="flex flex-col gap-2 rounded-xl p-6 border border-slate-200 dark:border-slate-700 bg-white dark:bg-card-dark">
        ...
        <p class="font-display text-slate-900 dark:text-slate-100 text-3xl font-bold leading-tight">Ohio State Certified (PK-12) |
        Québec Permis Probatoire d'Enseigner</p>
    </div>
    <div class="flex flex-col gap-2 rounded-xl p-6 border border-slate-200 dark:border-slate-700 bg-white dark:bg-card-dark">
